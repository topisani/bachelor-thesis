...
\todo{EDA Syntax has not been introduced yet, move this to later?}
\begin{cppcodenl}
...
As a shorthand for \cpp{lit(0.5)}, the user-defined literal \cpp{0.5_eda} is also provided:
\begin{cppcodenl}
...
hyperbolic tangent function (as used in \autoref{chap:multirate}), and the modulo operation.
...
\begin{cppcodenl}
  ...
  struct Partial : BlockBase<Partial<Block, Inputs...>, ins<Block> + (ins<Inputs> + ...) - (outs<Inputs> + ...), outs<Block>> 
  {
