...
\newcommand{\quickpagecount}[1]{%
    \quickcharcount{#1}%
    \quickwordcount{#1}%
    \thecharcount characters and approximately \thewordcount spaces = {\xinttheiexpr[2](\thewordcount+\thecharcount)/4200\relax} standard pages%
}
